...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>若使用 <code>dpkg</code> 安装后，系统中不包含某些依赖，可使用 <code>sudo apt install -f</code> 安装缺失依赖。</p><p>例如以下情形：</p><p><img src="`+t+'" alt="dpkg-error"></p><h2 id="🚙-snap" tabindex="-1"><a class="header-anchor" href="#🚙-snap" aria-hidden="true">#</a> 🚙 snap</h2><p><code>snap</code> 是 <code>Canoncial</code> 公司提出的新一代 <code>linux</code> 包管理工具，它类似一个容器拥有一个应用程序所有的文件和库，各个应用程序之间完全独立。</p><p>使用 <code>snap</code> 包的好处就是它解决了应用程序之间的依赖问题（包含一个私有的root文件系统，里面包含了依赖的软件包），使应用程序之间更容易管理，一般安装在 <code>/snap</code> 目录下。</p>',19),u={href:"https://snapcraft.io/store",target:"_blank",rel:"noopener noreferrer"},v=i(`<p>常用命令：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 搜索</span>
